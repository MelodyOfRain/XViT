...
class MixedGen(object):
    ...
    def __init__(self, filename, max_shift=0.5, max_strain=0.04, min_domain_size=1, max_domain_size=100, max_texture=0.6, impur_amt=70.0, min_angle=10.0, max_angle=80.0, ref_dir='References'):
        """
        Args:
        ...
        self.struc = Structure.from_file(os.path.join(ref_dir,filename))
    ...
    def clean_specs(self):
        ref_patterns = np.load(os.path.join(self.ref_dir+'_spec',self.filename+'.npy'))
        return ref_patterns
